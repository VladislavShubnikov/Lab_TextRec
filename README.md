...
* Извлечение 8-ми градиентных [признаков](1.) и 2-х суммарных [признаков](2.). Эти 10 чисел являются вектором - дескриптором прямоугольника
...
## Ссылки и литература
###### 1.
P.Frey, D.Slate, "Letter Recognition Using Holland-Style Adaptive Classifiers", Machine Learning, 1991. [PDF](https://ai2-s2-pdfs.s3.amazonaws.com/b421/fa2ce87913a88002e7a8f917afcd3733b8b4.pdf)
###### 2.
Y.Chung, M.Wong, "Handwritten Character Recognition By Fourier Descriptors and Neural Network", IEEE, 1997. [PDF](http://ieeexplore.ieee.org/stamp/stamp.jsp?arnumber=647338)
